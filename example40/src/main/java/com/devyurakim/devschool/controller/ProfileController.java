...
import com.devyurakim.devschool.model.Profile;
...
public class ProfileController {
    ...
    public String displayMessages(Model model, HttpSession session) {
        //dashboard controller에서 session에 Person 정보 저장함
